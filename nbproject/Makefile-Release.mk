...
${OBJECTDIR}/Color.o: Color.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Color.o Color.cpp

${OBJECTDIR}/Explossion.o: Explossion.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Explossion.o Explossion.cpp

${OBJECTDIR}/Faction.o: Faction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Faction.o Faction.cpp

${OBJECTDIR}/ForOfWar.o: ForOfWar.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ForOfWar.o ForOfWar.cpp
...
${OBJECTDIR}/Keyboard.o: Keyboard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Keyboard.o Keyboard.cpp
...
${OBJECTDIR}/Mouse.o: Mouse.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mouse.o Mouse.cpp
...
${OBJECTDIR}/Size.o: Size.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Size.o Size.cpp
...
${OBJECTDIR}/gui/Container.o: gui/Container.cpp 
	${MKDIR} -p ${OBJECTDIR}/gui
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/Container.o gui/Container.cpp
...
${OBJECTDIR}/gui/Frame.o: gui/Frame.cpp 
	${MKDIR} -p ${OBJECTDIR}/gui
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/Frame.o gui/Frame.cpp
...
${OBJECTDIR}/units/BattleDriller.o: units/BattleDriller.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/units/BattleDriller.o units/BattleDriller.cpp

${OBJECTDIR}/units/Builder.o: units/Builder.cpp 
	${MKDIR} -p ${OBJECTDIR}/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/units/Builder.o units/Builder.cpp

${OBJECTDIR}/units/Torpedo.o: units/Torpedo.cpp 
	${MKDIR} -p ${OBJECTDIR}/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/units/Torpedo.o units/Torpedo.cpp
