...
${OBJECTDIR}/gui/Button.o: gui/Button.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/Button.o gui/Button.cpp
...
${OBJECTDIR}/gui/Frame.o: gui/Frame.cpp 
	${MKDIR} -p ${OBJECTDIR}/gui
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/Frame.o gui/Frame.cpp

${OBJECTDIR}/gui/GUI.o: gui/GUI.cpp 
	${MKDIR} -p ${OBJECTDIR}/gui
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/GUI.o gui/GUI.cpp

${OBJECTDIR}/gui/Lebel.o: gui/Lebel.cpp 
	${MKDIR} -p ${OBJECTDIR}/gui
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/Lebel.o gui/Lebel.cpp
